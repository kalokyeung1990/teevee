...
from teevee.helper.common import try_float
from teevee.oldbeard import config, ui
...
class ConfigProviders(Config):
    ...
    def saveProviders(self):
        ...
        for provider_id, enabled in (provider.split(":") for provider in provider_order.split()):
            ...
            current_provider_object = [x for x in teevee.oldbeard.providers.sorted_provider_list() if x.get_id() == provider_id and hasattr(x, "enabled")]
        ...
        teevee.oldbeard.providers.check_enabled_providers()
