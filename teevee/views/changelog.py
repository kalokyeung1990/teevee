...
class HomeChangeLog(Home):
    def index(self, *args, **kwargs):
        ...
        try:
            changes = helpers.getURL("https://raw.githubusercontent.com/kalokyeung1990/teevee/master/CHANGES.md", session=helpers.make_session(), returns="text")
        except Exception:
            logger.debug("Could not load changes from repo, giving a link!")
            changes_url = "https://raw.githubusercontent.com/kalokyeung1990/teevee/master/CHANGES.md"
