...
from teevee.helper.metaclasses import Singleton
from teevee.oldbeard.classes import SearchResult

if TYPE_CHECKING:
    from teevee.tv import TVEpisode, TVShow
    from teevee.oldbeard.subtitles import Scores
    from teevee.providers.GenericProvider import GenericProvider

from teevee.helper.common import remove_extension, try_int
from teevee.helper.exceptions import EpisodeNotFoundException
from teevee.oldbeard.common import FAILED, Quality, SNATCHED, SUBTITLED, WANTED
