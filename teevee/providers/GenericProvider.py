...
from teevee import logger
from teevee.helper.common import sanitize_filename
from teevee.oldbeard import filters
from teevee.oldbeard.classes import Proper, SearchResult
from teevee.oldbeard.common import MULTI_EP_RESULT, Quality, SEASON_RESULT
from teevee.oldbeard.db import DBConnection
from teevee.oldbeard.helpers import download_file, getURL, make_session, remove_file_failed
from teevee.oldbeard.name_parser.parser import InvalidNameException, InvalidShowException, NameParser
from teevee.oldbeard.show_name_helpers import allPossibleShowNames
from teevee.oldbeard.tvcache import TVCache

if TYPE_CHECKING:
    from teevee.tv import TVEpisode
    ...
    def get_episode_search_strings(self, episode: "TVEpisode", add_string: str = "") -> Union[List[Dict], Iterable]:
        ...
        for show_name in allPossibleShowNames(episode.show, season=episode.scene_season):
            ...
            if episode.show.air_by_date:
                ...
                episode_string += teevee.oldbeard.config.naming_ep_type[2] % {
