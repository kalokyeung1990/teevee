            ...
            <div id="config-components">
                ...
                <div id="core-component-group1" class="tab-pane active component-group">
                    ...
                    <form id="addShowForm" method="post" action="${scRoot}/addShows/addExistingShows" accept-charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>${_('TeeVee can add existing shows, using the current options, by using locally stored NFO/XML metadata to eliminate user interaction. If you would rather have TeeVee prompt you to customize each show, then use the checkbox below.')}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5>${_("Displaying folders within these directories which aren't already added to TeeVee")}</h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
