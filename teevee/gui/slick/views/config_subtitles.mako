        ...
        <div id="subtitles-search">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <p>${_('Settings that dictate how TeeVee handles subtitles search results.')}</p>
                </div>
                        ...
                        <div id="content_use_subtitles" ${hidden(settings.USE_SUBTITLES)}>
                            ...
                            <div class="field-pair row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12 component-desc">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <span>${_('the directory where TeeVee should store your <i>Subtitles</i> files.')}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>
                                                    ${_('See')}
                                                    <a href="https://github.com/TeeVee/TeeVee/wiki/Subtitle%20Scripts">
