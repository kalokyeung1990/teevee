...
metadata = RegistrableExtensionManager(
    "teevee.providers.metadata",
    [
        "mede8er = teevee.providers.metadata.mede8er:Mede8erMetadata",
        "ps3 = teevee.providers.metadata.ps3:PS3Metadata",
        "tivo = teevee.providers.metadata.tivo:TIVOMetadata",
        "mede8er = teevee.providers.metadata.mede8er:Mede8erMetadata",
        "tivo = teevee.providers.metadata.tivo:TIVOMetadata",
        "mediabrowser = teevee.providers.metadata.mediabrowser:MediaBrowserMetadata",
        "wdtv = teevee.providers.metadata.wdtv:WDTVMetadata",
        "kodi = teevee.providers.metadata.kodi:KODIMetadata",
        "wdtv = teevee.providers.metadata.wdtv:WDTVMetadata",
        "kodi = teevee.providers.metadata.kodi:KODIMetadata",
        "mediabrowser = teevee.providers.metadata.mediabrowser:MediaBrowserMetadata",
        "ps3 = teevee.providers.metadata.ps3:PS3Metadata",
