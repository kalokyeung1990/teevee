...
import teevee.oldbeard.search_queue
from teevee import logger, settings
from teevee.helper.exceptions import MultipleShowObjectsException
...
class DailySearcher(object):
    ...
    def run(self, force=False):
        ...
        dailysearch_queue_item = teevee.oldbeard.search_queue.DailySearchQueueItem()
