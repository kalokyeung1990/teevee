...
import teevee.helper.common
import teevee.oldbeard.subtitles
from teevee import adba, logger, settings
from teevee.helper.common import episode_num, get_extension, is_rar_file, remove_extension, replace_extension, SUBTITLE_EXTENSIONS
from teevee.helper.exceptions import EpisodeNotFoundException, EpisodePostProcessingFailedException, ShowDirectoryNotFoundException
    ...
    def _combined_file_operation(self, file_path, new_path: str, new_base_name, associated_files=False, action=None, subtitles=False):
        ...
        for cur_file_path in file_list:
            ...
            if cur_extension in SUBTITLE_EXTENSIONS and "." in path_current_file.stem:
                ...
                cur_lang_name = teevee.oldbeard.subtitles.from_code(cur_lang).name
