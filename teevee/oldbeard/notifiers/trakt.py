...
from teevee.oldbeard.trakt_api import TraktAPI, traktAuthException, traktException, traktServerBusy
...
class Notifier(object):
    ...
    def trakt_show_data_generate(data):
        ...
        for indexer, indexerid, title, year in data:
            show = {"title": title, "year": year, "ids": {teevee.indexer.slug(indexer): indexerid}}
