...
class Notifier(object):
    def __init__(self):
        self.session = teevee.oldbeard.helpers.make_session()
    ...
    def _sendPushalot(self, pushalot_authorizationtoken=None, event=None, message=None, force=False):
        ...
        jdata = teevee.oldbeard.helpers.getURL("https://pushalot.com/api/sendmessage", post_data=post_data, session=self.session, returns="json") or {}
