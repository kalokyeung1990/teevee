...
import teevee.oldbeard.common
from teevee import logger, settings
from teevee.helper.common import USER_AGENT
from teevee.oldbeard import common
from teevee.oldbeard.helpers import getURL, make_session
...
class Notifier(object):
    ...
    def _notify_pht(message, title="TeeVee", host=None, username=None, password=None, force=False):
        ...
        return teevee.oldbeard.notifiers.kodi_notifier._notify_kodi(
