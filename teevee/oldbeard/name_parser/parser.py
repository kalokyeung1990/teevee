...
from teevee.helper.common import remove_extension
from teevee.oldbeard import common, db, helpers, scene_exceptions, scene_numbering
from teevee.oldbeard.name_parser import regexes
        ...
        if matches:
            ...
            if best_result.is_air_by_date:
                ...
                if season_number is None or not episode_numbers:
                    try:
                        episode_object = teevee.indexer.episode(best_result.show, firstAired=best_result.air_date)
