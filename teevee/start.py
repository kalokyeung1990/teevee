...
import teevee
from teevee import logger, settings, show_updater, update_manager
from teevee.oldbeard.common import ARCHIVED, IGNORED, MULTI_EP_STRINGS, SD, SKIPPED, WANTED
from teevee.oldbeard.config import check_section, check_setting_bool, check_setting_float, check_setting_int, check_setting_str, ConfigMigrator
from teevee.oldbeard.databases import failed, main
from teevee.oldbeard.providers.newznab import NewznabProvider
from teevee.oldbeard.providers.rsstorrent import TorrentRssProvider
...
def initialize(console_logging: bool = True, debug: bool = False, dbdebug: bool = False, disable_file_logging: bool = False) -> bool:
    with settings.INIT_LOCK:
        ...
        try:
            settings.WEB_PORT = check_setting_int(settings.CFG, "General", "web_port", 3333, min_val=21, max_val=65535)
        except Exception:
            settings.WEB_PORT = 3333
        ...
        teevee.indexer = teevee.ShowIndexer()
