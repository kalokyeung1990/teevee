...
from teevee.oldbeard import classes, notifiers
...
class Logger(object):
    ...
    def __init__(self):
        self.logger = logging.getLogger("teevee")

        self.loggers = [
            logging.getLogger("teevee"),
            logging.getLogger("teevee.movie"),
    ...
    def init_logging(self, console_logging=False, file_logging=False, debug_logging=False, database_logging=False):
        ...
        """
        self.log_file = self.log_file or os.path.join(settings.LOG_DIR, "teevee.log")
