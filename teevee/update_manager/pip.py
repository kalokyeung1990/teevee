...
from teevee.init_helpers import get_current_version, teevee_dir
from teevee.oldbeard import helpers, notifiers
...
class PipUpdateManager(UpdateManagerBase):
    ...
    def get_newest_version(self) -> packaging_version.Version:
    ...
    def pip_install(self, packages: Union[List[str], str, Path]) -> bool:
        ...
        syno_wheelhouse = teevee_dir.with_name("wheelhouse")
